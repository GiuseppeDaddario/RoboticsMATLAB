% Function for computing the inverse kinematics with the iterative Gradient method
% Takes parameters:
...
function theta = gradientMethod(r, q, l, q_val, l_val, p, max_iter, tol, alpha)
% Init
...
for k = 1:max_iter
    ...
    % Update theta using the Gradient method
    gradient = J_current' * error;
    theta = theta + alpha * gradient;
    all_vals = num2cell([theta.', l_val]);
end

if ~converged
    disp("Gradient method didn't converge");
end
